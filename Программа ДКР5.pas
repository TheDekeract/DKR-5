...
var
  ...
  out2text: text;
  arr2: array[0..10000] of char;
  n1, n2, star,stop,star1,stop1: integer;

function vstavka: integer;
var
  i, j, min: integer;
  buf: char;
begin
...
begin
  ...
  writeln('1-Сортировка алгоритмом вставок');
  writeln('2-Сортировка по возрастанию алгоритмом слияния');
  writeln('3-Сортировка по убыванию алгоритмом слияния');
  writeln('0-Выход');
  var a: integer;
  read(a);
  case a of
    1:
     begin
       star1:=DateTime.Now.Second;
        ...
        vstavka;
        writeln('Сортировка алгоритмом вставок:');  
        for var i := 1 to n2 do 
        begin
          write(arr2[i], ' ');
        end;
...
begin
  ...
  readln(n2);
  Assign(in2text, 'DKR5in2.txt');
  Assign(out2text,'DKR5out2.txt');
  rewrite(in2text);
  var a: char;
  rewrite(in2text);
  writeln('Массив - ');
  ...
  kopr;
  rewrite(out2text);
  writeln(out2text, 'Сортировка алгоритмом вставок: ');
  for var i := 1 to n2 do 
  begin
